 ...
 * @author tahir
 */
public class FiltrePrecis extends HttpServlet {
        ...
        java.sql.Connection c = null;
                    try {
                              ...
                              ArrayList<V_stat_complet> ls = V_stat_complet.getListByProduit(c, request.getParameter("meuble"), request.getParameter("style"), request.getParameter("volume"));
                              ArrayList<Integer> data = new ArrayList<Integer>();
                              ArrayList<String> label = new ArrayList<String>();
                              for(V_stat_complet stat : ls){
                                        data.add(stat.getNbvente());
                                        label.add(stat.getNomgenre());
                              }
