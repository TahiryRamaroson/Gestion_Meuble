 ...
 * @author tahir
 */
public class ListVolumeServlet extends HttpServlet {
          ...
          protected void processRequest(HttpServletRequest request, HttpServletResponse response)
                  throws ServletException, IOException {
                    ...
                    try {
                              ...
                              ArrayList ls = Volume.selectAll(c);

                              HttpSession session = request.getSession();
                              session.setAttribute("lsAllVolumes", ls);
//            RequestDispatcher rqd = request.getRequestDispatcher("associationMatiereStyle.jsp");
//            rqd.forward(request, response);
                              response.sendRedirect("travailouvrier.jsp");
                    } catch (Exception e) {
                              e.printStackTrace();
